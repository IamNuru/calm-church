...
function _typeof(e) {
    ...
    function o(e) {
        if (console.error("[ZemezCore] error:", "\n", e), 
            ...
            t.setAttribute("style", "position: fixed; bottom: 1vh; left: 1vw; z-index: 1000; max-width: 98vw; padding: 10px 15px; border-radius: 4px; font-family: monospace; background: #f2564d; color: white;"), 
            t.innerText = "There was an error on this page, please try again later.", 
    ...
    r.defaults = {
    ...
    }, r.prototype.includeStyles = function(a) {
        var e = a.substring(1)
    ...
    }, r.prototype.includeScript = function(a) {
        var e = a.substring(1)
        return new Promise(function(t, n) {
        ...
        var t = Promise.resolve(),
            n = Promise.resolve();
        return this.debug && 
        console.log("%c[".concat(e.name, "] init:"), "color: lightgreen; font-weight: 900;", e.nodes.length), 
        e.state = "load", 
        e.styles && (t = t.then(this.makeAsync.bind(this, e.styles, this.includeStyles))["catch"](this.onError)), 
        e.script && (n = n.then(this.makeSync.bind(this, e.script, this.includeScript))["catch"](this.onError)), 
        e.dependencies && (n = n.then(this.makeSync.bind(this, e.dependencies, this.checkComponent.bind(this)))["catch"](this.onError)), 
        e.init && (n = n.then(e.init.bind(this, e.nodes))["catch"](this.onError)), t.then(function() {
