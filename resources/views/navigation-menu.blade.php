<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('sermons') }}" :active="request()->routeIs('sermons')">
                        {{ __('Sermons') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('donations') }}" :active="request()->routeIs('donations')">
                        {{ __('Donations') }}
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('sermons') }}" :active="request()->routeIs('sermons')">
                {{ __('Sermons') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('donations') }}" :active="request()->routeIs('donations')">
                {{ __('Donations') }}
            </x-jet-responsive-nav-link>
