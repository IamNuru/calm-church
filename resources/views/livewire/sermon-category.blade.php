            ...
            {{-- <form  wire:submit.prevent="store((Object.fromEntries(new FormData($event.target))))"> --}}
               ...
               <input type="hidden" name="hiddenid">
                <div>
                    ...
                    <x-jet-input id="name" class="block mt-1 w-full" type="text" wire:model="name" name="name" :value="old('name')" required autocomplete="off" />
                    <x-jet-input-error for="name" class="mt-1" />
                </div>
                <div class="mt-4">
                    <x-jet-label for="description" value="{{ __('Description') }}" />
                    <textarea id="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" type="text" wire:model="description" name="description" :value="old('name')" required autocomplete="off"></textarea>
                ...
                <table class='mx-auto max-w-4xl w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>
                    ...
                    <thead class="bg-gray-700" style="background-color: rgb(182, 174, 174)">
                        <tr class="text-white text-left">
                            ...
                            <th class="font-semibold text-sm px-6 py-2"> # of sermons </th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-2 text-center">
                                <p class=""> {{count($category->sermons)}} </p>
                            </td>
